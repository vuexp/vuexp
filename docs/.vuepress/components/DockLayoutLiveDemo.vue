<template>
  <StackLayout>
    ...
    <StackLayout orientation="vertical" class="demo-panel">
      ...
      <StackLayout orientation="horizontal" v-for="(dockChild, index) in dockChildrenList">
        <StackLayout orientation="horizontal" class="editor-param">
          ...
          <input :id="'docklayout_childreneditor_name' + index" type="text" style="width:50px" v-model="dockChildrenList[index].text">
        </StackLayout>
        <StackLayout orientation="horizontal" class="editor-param">
        ...
        <StackLayout orientation="horizontal" class="editor-param">
          <button :id="'docklayout_childreneditor_removechild' + index" @click="removeChildAtIndex(index)">❌</button>
        </StackLayout>
      </StackLayout>
    </StackLayout>
    <!-- Children list editor -->
    ...
    <StackLayout style="margin-top:20px" class="demo-panel">
      ...
      <DockLayout id="docklayout_thedocklayout" :stretchLastChild="stretchLastChildSelected" class="dock">
        <Label
